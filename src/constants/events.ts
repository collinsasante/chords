...
export const EVENTS: Event[] = [
  ...
  {
    title: 'Outreaches & Get-Togethers',
    date: 'Throughout the Year',
    location: 'UENR Campus & Beyond',
    description:
      'Beyond the big stage, Chords Ministry takes the sound of the Gospel into lecture halls, hostels, and communities. Regular ministrations and get-togethers keep the family connected and the mission alive all year long.',
    image:
